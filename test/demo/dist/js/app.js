...
var _httpUtil = __webpack_require__(6);
...
var _sildeBarrage = __webpack_require__(18);

var _sildeBarrage2 = _interopRequireDefault(_sildeBarrage);
...
var mainVue = new _vue2.default({
  ...
  data: {},
  comonents: {
    SlideBarrage: _sildeBarrage2.default
  },
  methods: {
...
if(false) {
	module.hot.accept("!!../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../node_modules/_postcss-loader@2.1.5@postcss-loader/lib/index.js??ref--4-2!../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./index.less", function() {
		var newContent = require("!!../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../node_modules/_postcss-loader@2.1.5@postcss-loader/lib/index.js??ref--4-2!../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./index.less");
...
// module
exports.push([module.i, "body {\n  width: 100%;\n  height: 100%;\n  font-size: 1rem;\n  background: url(" + escape(__webpack_require__(14)) + ") no-repeat center top;\n}\ndiv {\n  display: -ms-flexbox;\n  display: flex;\n}\n", ""]);
...
Component.options.__file = "E:\\goddancer\\myspace\\webpack-gulp\\library\\components\\slideBarrage\\sildeBarrage.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] sildeBarrage.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9447a87a", Component.options)
  } else {
    hotAPI.reload("data-v-9447a87a", Component.options)
  }
})()}
...
var _CommentService = __webpack_require__(21);
...
exports.default = {
  ...
  mounted: function mounted() {
    if (this.auto) {
      var that = this;
      var barrageService = new _CommentService.CommentService(this.barrageId, this.barrageNum, this.barrageType);
      var barrageSet = new _Set.Set('pid', 'dateline');
  ...
  methods: {
    moreSlide: function moreSlide(n) {
      var the = this;
      var barrageService = new _CommentService.CommentService(this.barrageId, this.barrageNum, this.barrageType);
      var barrageSet = new _Set.Set('pid', 'dateline');
    ...
    emptySlide: function emptySlide(show, p) {
      /*暴露给父组件操控是否显示弹幕以及弹幕跳转的方法*/
      var page = p || this.num;
      this.barrageData = [];
      if (show) {
        this.moreSlide(page);
...
var _DateUtil = __webpack_require__(22);
...
var CommentService = exports.CommentService = function () {
  /**
   * CommentService 评论的接口服务,查看例子<a href='../test/service/CommentService/index.html'> CommentService的使用</a>
   * @requires jquery
   * @param zid {String} zid 评论的ID
   * @param ps {int} ps 评论每页条数
   * @param app {String} app 客户端名称 1）新闻：cctvnews 2）影音：cbox
   */
  function CommentService(zid, ps, app) {
    ...
    //this.url = `http://common.newcomment.cntv.cn/comment/list?app=${this.app}&itemid=${this.zid}&prepage=${this.ps}`;//原
    //this.url = `http://common.newcomment.cntv.cn/data/line?app=${this.app}&itemid=${this.zid}&prepage=${this.ps}`;//博哥新配置20180213
    this.url = 'http://common.newcomment.cntv.cn/data/list?app=' + this.app + '&itemid=' + this.zid + '&reply=1&prepage=' + this.ps + '&special=1&top=1&avatar=1 '; //仅今日说法订阅号底层页适用
  }
  ...
  _createClass(CommentService, [{
    ...
    value: function get(callback, pn) {
      ...
      _jquery2.default.ajax({
        ...
        jsonpCallback: 'getCb_' + this.app + '_' + this.zid,
        cache: true,
        url: this.url,
        data: { 'page': page, 't_': _DateUtil.DateUtil.getWantTime(100000) },
     ...
     * @param pn {int} 页码 不传值是1
     */
    value: function jumpTo(callback, pn) {
      var that = this;
      that.pn = pn || 1;
      _jquery2.default.ajax({
        dataType: 'jsonp',
        jsonp: 'jsonp_callback',
        jsonpCallback: 'jumpTocallback', //jumpTocallback_'+this.app+'_'+this.zid+'
        url: this.url,
        cache: true,
        data: { 'page': that.pn }, //,'t_':DateUtil.getWantTime(100000)
        success: function success(data) {
          callback(data);
        }
      });
    ...
    value: function interval(callback, _interTime) {
      _interTime = _interTime || 30000;
      var that = this;
      setInterval(function () {
        _jquery2.default.ajax({
          dataType: 'jsonp',
          jsonp: 'jsonp_callback',
          jsonpCallback: 'intervalcallback_' + that.app + '_' + that.zid + '',
          cache: true,
          url: that.url,
          data: { 'page': 1, 't_': _DateUtil.DateUtil.getWantTime(100000) },
          success: function success(data) {
            callback(data);
          }
        });
    ...
    /**
     * 提交用户评论，可以设置 昵称、头像、图片
     * @param _content { String } 评论内容
     * @param _nickname {String} 昵称 可以不写
     * @param _head {String} 头像地址
     * @param _pic {String} 用户上传的图片地址
     */
    value: function submitComment(_content, _nickname, _head, _pic) {
     ...
     * @param _pic {String} 用户上传的图片地址
     */
    value: function submitUserComment(_content, userId, _nickname, _head, _pic, callback) {
      var userId = userId;
      var zid = this.zid;
      var data = {
        app: this.app,
      ...
      if (_content || _pic) {
        _jquery2.default.ajax({
          url: 'http://newcomment.cntv.cn/comment/post',
          data: data,
          xhrFields: {
    ...
    value: function agree(_replyId) {
      var data = encodeURIComponent(_jquery2.default.base64.encode('uid=12211121&time=' + new Date().getTime() / 1000));
      var zid = this.zid;
      var agreeApp = this.app;
      if (_replyId) {
        _jquery2.default.ajax({
          dataType: 'jsonp',
          jsonp: 'jsonp_callback',
          jsonpCallback: 'agreecallback_' + agreeApp + '_' + zid + '',
    ...
    value: function pageReply(_replyId, _callback) {
      ...
      var pageReplayApp = this.app;
      if (_replyId) {
        _jquery2.default.ajax({
          dataType: 'jsonp',
          jsonp: 'jsonp_callback',
          jsonpCallback: 'pageReplycallback_' + pageReplayApp + '_' + _itemId + '',
    ...
    value: function initReplyComment(_callback) {
      ...
      var initReplayApp = this.app;
      _jquery2.default.ajax({
        dataType: 'jsonp',
        jsonp: 'jsonp_callback',
        jsonpCallback: 'initReplyCommentcallback_' + initReplayApp + '_' + commentItemid + '',
        url: crul,
        success: function success(data) {
          _callback(data);
        }
    ...
    value: function getReplyComment(_pn, _callback) {
      ...
      var crul = 'http://common.newcomment.cntv.cn/reply/special?app=cctvnews&itemid=' + commentItemid + '&itemtype=0&prepage=' + commentPrepage + '&page=' + commentPage;
      var getReplayApp = this.app;
      _jquery2.default.ajax({
        dataType: 'jsonp',
        jsonp: 'jsonp_callback',
        jsonpCallback: 'getReplyCommentcallback_' + getReplayApp + '_' + commentItemid + '',
        url: crul,
        success: function success(data) {
          _callback(data);
        }
    ...
    value: function intervalReplyComment(_interTime, _callback) {
      ...
      var intervalReplayApp = this.app;
      $interval(function () {
        _jquery2.default.ajax({
          dataType: 'jsonp',
          jsonp: 'jsonp_callback',
          jsonpCallback: 'intervalReplyCommentcallback_' + intervalReplayApp + '_' + commentItemid + '',
          url: crul,
          success: function success(data) {
            _callback(data);
          }
...
var DateUtil = exports.DateUtil = function () {
  ...
  _createClass(DateUtil, null, [{
    key: "getYyyyMmDd",
    value: function getYyyyMmDd(date, separator) {
    ...
    key: "getWantTime",
    value: function getWantTime(divisor) {
      return parseInt(new Date().getTime() / divisor);
    }
  }, {
    key: "toSpeclen",
    value: function toSpeclen(num, len) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, _vm._l((_vm.barrageData), function(item, index) {
    return _c('li', {
      key: item,
      staticClass: "clear",
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-9447a87a", module.exports)
  }
}
